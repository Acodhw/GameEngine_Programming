...
#include "..\\PracticeEngine_SOURCE\\PERenderer.h"
#include "..\\PracticeEngine_SOURCE\\PEGameObject.h"
#include "..\\PracticeEngine_SOURCE\\PETransform.h"
#include "..\\PracticeEngine_SOURCE\\PEInput.h"
#include "..\\PracticeEngine_SOURCE\\PEMouseEvent.h"
...
namespace GUI
{
	...
	PracticeEngine::Math::Vector2 EditorApplication::mViewportBounds[2] = {};
	PracticeEngine::Math::Vector2 EditorApplication::mViewportSize;
	...
	PracticeEngine::Graphics::RenderTarget* EditorApplication::mFrameBuffer = nullptr;
	PracticeEngine::EventCallbackFn EditorApplication::mEventCallback = nullptr;

	bool EditorApplication::Initialize()
	{
		mImguiEditor = new ImguiEditor();
		mFrameBuffer = PracticeEngine::Renderer::FrameBuffer;
	...
	void EditorApplication::OnEvent(PracticeEngine::Event& e)
	{
		if (!e.Handled)
		{
	...
	void EditorApplication::OnImGuiRender()
	{
		...
		PracticeEngine::Graphics::Texture* texture = mFrameBuffer->GetAttachmentTexture(0);
		...
		PracticeEngine::GameObject* selectedObject = PracticeEngine::Renderer::selectedObject;
		...
		if (selectedObject && mGuizmoType != -1)
		{
			...
			// Scene Camera
			const PracticeEngine::Math::Matrix& viewMatrix = PracticeEngine::Renderer::mainCamera->GetViewMatrix();
			const PracticeEngine::Math::Matrix& projectionMatrix = PracticeEngine::Renderer::mainCamera->GetProjectionMatrix();

			// Object Transform
			PracticeEngine::Transform* transform = selectedObject->GetComponent<PracticeEngine::Transform>();
			PracticeEngine::Math::Matrix worldMatrix = transform->GetWorldMatrix();

			// snapping
			bool snap = PracticeEngine::Input::GetKey(PracticeEngine::eKeyCode::Leftcontrol);
			...
			if (ImGuizmo::IsUsing())
			{
				...
				PracticeEngine::Math::Vector3 deltaRotation = Vector3(rotation) - transform->GetRotation();
	...
	{
		PracticeEngine::MouseMovedEvent event(x, y);
