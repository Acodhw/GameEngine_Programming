...
#include "..\\PracticeEngine_SOURCE\\PERenderTarget.h"
#include "..\\PracticeEngine_SOURCE\\PEEvent.h"
...
namespace GUI
{
	...
	public:
		...
		static void OnEvent(PracticeEngine::Event& e);
	...
	private:
		...
		static PracticeEngine::Math::Vector2 mViewportBounds[2];
		static PracticeEngine::Math::Vector2 mViewportSize;
		static bool mViewportFocused;
		static bool mViewportHovered;
		static int mGuizmoType;

		static PracticeEngine::Graphics::RenderTarget* mFrameBuffer;
		static PracticeEngine::EventCallbackFn mEventCallback;
	};
}
