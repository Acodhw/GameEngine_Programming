...
namespace GUI
{
	...
	void ImguiEditor::Initialize()
	{
		...
		PracticeEngine::Graphics::GraphicsDevice_DX11*& graphicdevice = PracticeEngine::Graphics::GetDevice();
	...
	void ImguiEditor::OnEvent(PracticeEngine::Event& e)
	{
		// Block event when ImGui is capturing mouse or keyboard
		if (mBlockEvent)
		{
			ImGuiIO& io = ImGui::GetIO();
			e.Handled |= e.IsInCategory(PracticeEngine::eEventCategory::EventCategoryMouse) & io.WantCaptureMouse;
			e.Handled |= e.IsInCategory(PracticeEngine::eEventCategory::EventCategoryKeyboard) & io.WantCaptureKeyboard;
		}
	}
